...
<style Stylesheet="text/css">
 @font-face {
  ...
  src: url('<?php echo $path; ?>styles/fonts/logofont.eot'); /* IE9 Compat Modes */
  src: url('<?php echo $path; ?>styles/fonts/logofont.eot?#iefix') format('embedded-opentype'), /* IE6-IE8 */
       url('<?php echo $path; ?>styles/fonts/logofont.woff2') format('woff2'), /* Super Modern Browsers */
       url('<?php echo $path; ?>styles/fonts/logofont.woff') format('woff'), /* Pretty Modern Browsers */
       url('<?php echo $path; ?>styles/fonts/logofont.ttf')  format('truetype'), /* Safari, Android, iOS */
       url('<?php echo $path; ?>styles/fonts/logofont.svg#svgFontName') format('svg'); /* Legacy iOS */
}
 ...
 <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
		...
		<li style="position:relative;left:370px;"><a href="<?php echo $path; ?>index.php/AdminHome/Logout">
                <?php
              echo '<img src="'.$path.'styles/images/logout.png">';
                ?>
            </a>
        </li>
        </ul>
