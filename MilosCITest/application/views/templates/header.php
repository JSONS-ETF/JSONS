 ...
 @font-face {
  ...
  src: url('../styles/fonts/logofont.eot'); /* IE9 Compat Modes */
  src: url('../styles/fonts/logofont.eot?#iefix') format('embedded-opentype'), /* IE6-IE8 */
       url('../styles/fonts/logofont.woff2') format('woff2'), /* Super Modern Browsers */
       url('../styles/fonts/logofont.woff') format('woff'), /* Pretty Modern Browsers */
       url('../styles/fonts/logofont.ttf')  format('truetype'), /* Safari, Android, iOS */
       url('../styles/fonts/logofont.svg#svgFontName') format('svg'); /* Legacy iOS */
}
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        ...
        <li><div class="logo">Questy</div></li>
		      <li><a href="homepage.php"><img src="../styles/images/home.png"></a></li>
          <li class="active"><a href="inbox.php"><img src="../styles/images/inbox.png"></a></li>
          <li><a href="profile.php"><img src="../styles/images/profile.png"></a></li>
          <li style="position:relative;left:370px;"><a href="logout.php"><img src="../styles/images/logout.png"></a></li>
        </ul>
      </div>
